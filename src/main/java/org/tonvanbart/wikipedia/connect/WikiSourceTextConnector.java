...
/**
 * Source connector with just sends the raw text of incoming messages.
 * Filtering on "data;" lines and JSON processing are moved to Simple Message Transforms.
 * This class shares config with {@link WikiSourceConnector}.
 */
@Slf4j
public class WikiSourceTextConnector extends SourceConnector {
    ...
    public Class<? extends Task> taskClass() {
        log.info("taskClass()");
        return WikiSourceTextTask.class;
    }
